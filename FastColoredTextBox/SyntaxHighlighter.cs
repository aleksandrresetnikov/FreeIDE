...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        public Regex XMLAttrRegex,
                      XMLAttrValRegex,
                      XMLCommentRegex1,
                      XMLCommentRegex2;

        public Regex XMLEndTagRegex;

        public Regex XMLEntityRegex,
                      XMLTagContentRegex;

        public Regex XMLTagNameRegex;
        public Regex XMLTagRegex;
        public Regex XMLCDataRegex;
        public Regex XMLFoldingRegex;
...
";
        ...
        public void XmlFolding(Range range)
        {
