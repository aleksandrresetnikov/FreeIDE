...
{
    internal class FlatTabControlTag : IThemeTag
    {
        private int[] themeTags = new int[] { 0, 0 };

        public object FreeTag { get; set; } = null;

        public FlatTabControlTag(int themeTag) => this.themeTags[0] = themeTag;
        public FlatTabControlTag(int themeTag1, int themeTag2) => this.themeTags = new int[] { themeTag1, themeTag2 };
        public FlatTabControlTag(params int[] themeTags) => this.themeTags = themeTags;
