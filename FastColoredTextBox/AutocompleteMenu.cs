...
namespace FastColoredTextBoxNS
{
    ...
    {
        public AutocompleteListView listView;
        ...
        /// 
        /// </summary>
        public bool LinearGradientBrush { get; set; } = true;
        /// <summary>
        /// Link to parent FastColoredTextBox.
        /// </summary>
        ...
        public AutocompleteMenu(FastColoredTextBox tb)
        {
            ...
            listView.LinearGradientBrush = this.LinearGradientBrush;
    ...
    public class AutocompleteListView : UserControl, IDisposable
    {
        ...
        public bool LinearGradientBrush { get; set; }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (int i = startI;  i < finishI; i++)
            {
                ...
                using (var selectedBrush = this.BuildBrush(y, itemHeight))
                ...
                using (var brush = this.BuildStringBrush(item))
                    e.Graphics.DrawString(item.ToString(), Font, brush, leftPadding, y);
            }
        }

        private protected virtual Brush BuildBrush(int y, int itemHeight)
        {
            if (this.LinearGradientBrush)
                return new LinearGradientBrush(new Point(0, y - 3), new Point(0, y + itemHeight),
                    Color.Transparent, SelectedColor);
            else
                return new SolidBrush(SelectedColor);
        }

        private protected virtual Brush BuildStringBrush(AutocompleteItem item)
        {
            return new SolidBrush(item.ForeColor != Color.Transparent ? item.ForeColor : ForeColor);
        }
